            ...
            <div className="flex mt-12 h-full flex-col overflow-hidden bg-white shadow-xl">
                ...
                <div className="border-t border-gray-200 px-4 py-6 sm:px-6">
                    ...
                    <div className="mt-6">
                        <Link
                            to="/checkout"
                            className="bg-blue-500 flex items-center justify-center rounded-md border border-transparent  px-6 py-3 text-base font-medium text-white shadow-sm hover:bg-indigo-700"
                        >
                            Checkout
                        </Link>
                    </div>
