  ...
  return (
    <div className='h-[calc(100vh-120px)] flex justify-center items-center '>
        <div className='w-full max-w-sm mx-auto bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4'>
            ...
            <p className='align-baseline font-medium mt-4 text-sm'>Do you want to login as admin? <Link to="/admin" className='text-blue-500 hover:text-blue-700'>Admin</Link></p>
        </div>
    </div>
  )
}
